...
const EmployeeComponent = () => {
    ...
    if (validateForm()) {
      ...
      if (id) {
        updateEmployee(id, employee)
          .then((response) => { console.log(response.data); navigator('/employees');})
          .catch(error => {
            console.error(error);
      })
      } else {
        createEmployee(employee)
          .then((response) => {
            console.log(response.data);navigator('/employees')})
  ...
  function validateForm() {
    ...
    return valid && !errorsCopy.firstName && !errorsCopy.lastName && !errorsCopy.email
  }
